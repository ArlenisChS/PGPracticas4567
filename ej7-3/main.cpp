...
#define EQUAL_SPACING_TESE_SHADER "../ej7-3/shader-es.tese"
#define FRACTIONAL_ODD_SPACING_TESE_SHADER "../ej7-3/shader-fos.tese"
#define FRACTIONAL_EVEN_SPACING_TESE_SHADER "../ej7-3/shader-fes.tese"
...
void MyRender::setup() {
  ...
  program->loadFiles("../ej7-3/shader");
  program->addShader(
