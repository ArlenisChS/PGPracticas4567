...
void MyRender::setup() {
  ...
  std::shared_ptr<Shader> vShader =
    Shader::loadFromFile("../ej7-2/shader.vert");
  std::shared_ptr<Shader> fShader =
    Shader::loadFromFile("../ej7-2/shader.frag");
  ...
  quadsShader.addShader(Shader::loadFromFile("../ej7-2/quads.tesc"));
  quadsShader.addShader(Shader::loadFromFile("../ej7-2/quads.tese"));
  quadsShader.compile();
  ...
  std::shared_ptr<Shader> tcShader =
    Shader::loadFromFile("../ej7-2/isolines.tesc");
  ...
  isolinesShader.addShader(Shader::loadFromFile("../ej7-2/isolines.tese"));
  ...
  isolinesShaderPoints.addShader(
    Shader::loadFromFile("../ej7-2/isolines-points.tese"));
  ...
  trianglesShader.addShader(Shader::loadFromFile("../ej7-2/triangles.tesc"));
  trianglesShader.addShader(Shader::loadFromFile("../ej7-2/triangles.tese"));
